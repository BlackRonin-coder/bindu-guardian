...
from bindu_guardian.agents.explanation_engine import explain_decision
from bindu_guardian.agents.briefing_engine import build_briefing
...
for cycle in range(1, 4):
    ...
    explanation = explain_decision(situation, mapped, trend, pressure)
    briefing = build_briefing(situation, mapped, override, temporal)

    print(f"\n=== BINDU GUARDIAN DISTRIBUTED RUNTIME V7 / CYCLE {cycle} ===")
    print(json.dumps({
        "fusion_result": fused,
        "consensus": consensus,
