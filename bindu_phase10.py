...
from confidence_gate import should_escalate
...
for domain, actor_role in DOMAINS.items():
    ...
    gate = should_escalate(score, correlation["correlation_confidence"], tamper, auth["authorized"])
